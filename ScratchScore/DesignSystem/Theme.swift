...
enum Theme {
    enum Palette {
        static let fairway = Color(red: 0.204, green: 0.616, blue: 0.376)   // primary green (#349D60)
        static let fairwayDark = Color(red: 0.090, green: 0.267, blue: 0.153)
        static let rough = Color(red: 0.298, green: 0.451, blue: 0.298)
        static let sand = Color(red: 0.839, green: 0.651, blue: 0.298)      // secondary — warm sand/gold (#D6A64C)
...
extension ShapeStyle where Self == Color {
    ...
    static var ssSand: Color { Theme.Palette.sand }
